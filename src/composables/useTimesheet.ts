...
export function useTimesheet() {
  ...
  const getPreviewHtml = async (type: 'timesheet' | 'mandays') => {
    try {
      ...
      return response.data; // Return raw HTML string
    } catch (error) {
  ...
  return {
    ...
    syncData, fetchAssignees, enhanceDescription, loadPreview, downloadExcel, getPreviewHtml,
